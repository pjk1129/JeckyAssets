...
- (void)assetsCollectionViewController:(QBAssetsCollectionViewController *)assetsCollectionViewController didSelectAsset:(ALAsset *)asset didFinishEditedImag:(UIImage *)image
{
    if (_delegate && [_delegate respondsToSelector:@selector(qb_imagePickerController:didSelectAsset:didFinishEditedImag:)]) {
        [_delegate qb_imagePickerController:self didSelectAsset:asset didFinishEditedImag:image];
    }
}
...
- (void)assetsCollectionViewController:(QBAssetsCollectionViewController *)imageBrowseController didFinishPickingImage:(UIImage *)image
{
