...
@interface QBAssetsCollectionViewController ()<QBImageBrowseViewControllerDelegate>
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ALAsset *asset = self.assets[indexPath.row];
    if (!self.allowsMultipleSelection) {
        QBImageBrowseViewController  *controller = [[QBImageBrowseViewController alloc] init];
...
#pragma mark - QBImageBrowseViewControllerDelegate
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(assetsCollectionViewController:didSelectAsset:didFinishEditedImag:)]) {
        [self.delegate assetsCollectionViewController:self didSelectAsset:asset didFinishEditedImag:image];
    }
}
